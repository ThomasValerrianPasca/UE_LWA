...
public_rlc(protocol_ctxt_t temp_ctxt_pP;)
public_rlc(srb_flag_t  temp_srb_flagP;)
public_rlc(MBMS_flag_t temp_MBMS_flagP;)
		public_rlc(rb_id_t  temp_rb_idP;)
//static sdu_size_t  temp_sdu_sizeP;
		public_rlc(mem_block_t  *temp_sdu_pP;)
