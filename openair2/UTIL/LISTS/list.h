...
public_list( int          list_get_el_num(list_t * listP);)
public_list( void         list_add_reorder (mem_block_t* , list_t* );)
public_list( mem_block_t* list_get_from_reorder_list (list_t* );)
public_list( uint16_t	  peek_sequence_number_from_reorder_list(list_t* );)
